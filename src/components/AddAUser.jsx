...
const SaveUser =(props)=>{
  ...
  const submitClicked=()=>{
    ...
    axios.post("http://localhost:9090/saveuser",user)
    .then((response)=>{
      ...
      <div className='col-6'>
        <form className='container'>
          ...
          <div className="form-group mb-3 mt-3" >
            ...
            <input type="text" className='form-control' name="usre_last_name" value={user.usre_last_name} onChange={onChnageLastName}   placeholder='Enter Last Name' required/>
          </div>

          <div className="form-group mb-3 mt-3" >
            <label>Email</label>
            <input type="email" className='form-control' name="userEmail" value={user.userEmail} onChange={onChnageEmail}   placeholder='Enter email' required/>
          </div>
